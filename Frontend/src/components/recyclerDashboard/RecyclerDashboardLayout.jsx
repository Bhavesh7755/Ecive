...
import { Home, Package, User, Settings, LogOut, Store } from "lucide-react";
        ...
        >
          <div className="p-6">
            ...
            <div className="bg-emerald-50 rounded-xl p-4 mb-6 flex items-center space-x-3">
              ...
              />
              <div>
                <h2 className="font-bold text-emerald-800">{recycler?.fullName || recycler?.shopName}</h2>
                <div className="text-sm text-emerald-600">{recycler?.email}</div>
              </div>
            </div>
